...
func NewDuoUIicons() (i map[string]*DuoUIicon) {
	...
	i["Backward"] = mustIcon(NewDuoUIicon(icons.AVFastRewind))
	i["Forward"] = mustIcon(NewDuoUIicon(icons.AVFastForward))
	i["Back"] = mustIcon(NewDuoUIicon(icons.AVSkipPrevious))
	i["Next"] = mustIcon(NewDuoUIicon(icons.AVSkipNext))
